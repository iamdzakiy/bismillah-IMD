...
export const TIMELINE_DATA = [
  {
    ...
    desc: 'Early bird registration begins',
    icon: '🚀',
  },
  {
    id: '2',
    phase: 'Workshop',
    date: '15 Jun 2026',
    title: 'Petri Dish Art Workshop',
    desc: 'Pre-event workshop',
    icon: '🎨',
  },
  {
    id: '3',
    ...
    desc: 'Expert-led training sessions',
    icon: '📚',
  },
  {
    id: '4',
    phase: 'Deadline',
    date: '10 Jul 2026',
    title: 'MO Registration Closes',
    desc: 'Olympiad deadline',
    icon: '⏰',
  },
  {
    id: '5',
    phase: 'Prelim',
    date: '15 Jul 2026',
    title: 'SPC & NEC Prelim',
    desc: 'Preliminary submissions',
    icon: '📝',
  },
  {
    id: '6',
    phase: 'Prelim',
    date: '20 Jul 2026',
    title: 'MO Preliminary',
    desc: 'Online test round',
    icon: '💻',
  },
  {
    id: '7',
