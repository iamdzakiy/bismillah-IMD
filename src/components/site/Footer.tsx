        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a href="mailto:archaea_itb@km.itb.ac.id" className="w-9 h-9 glass rounded-full flex items-center justify-center hover:bg-purple-500/20 transition-all group">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:archaea_itb@km.itb.ac.id" className="text-sm text-white/50 hover:text-purple-400 transition-colors">Email Us</a></li>
            </ul>
          </div>
