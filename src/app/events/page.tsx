...
const events = [
  {
    ...
    description: 'The grand opening ceremony of IMD 2026, featuring keynote speeches from distinguished microbiologists and university officials.',
    icon: '🎉',
    type: 'main',
  },
  {
    name: 'Workshops & Symposium',
    date: 'July 2026',
    time: 'TBA',
    venue: 'Institut Teknologi Bandung & Online',
    description: 'Expert-led workshops covering cutting-edge topics in microbiology, biotechnology, and scientific communication.',
    icon: '🔬',
    type: 'workshop',
  },
  {
    name: 'Microbiology Olympiad (MO)',
    date: '17 Oct - 15 Nov 2026',
    time: 'See timeline',
    venue: 'Online & ITB Ganesha',
    description: 'OSN-level microbiology competition for SMA students. Preliminary round online, final round onsite at ITB.',
    icon: '🏆',
    type: 'competition',
  },
  {
    name: 'Science Project Competition (SPC)',
    date: '19 Jul - 15 Nov 2026',
    time: 'See timeline',
    venue: 'Online & ITB Ganesha',
    description: 'Team-based innovation competition to develop microbiology-based prototypes addressing global challenges.',
    icon: '🔬',
    type: 'competition',
  },
  {
    name: 'National Essay Competition (NEC)',
    date: '19 Jul - 15 Nov 2026',
    time: 'See timeline',
    venue: 'Online & ITB Ganesha',
    description: 'Scientific essay competition for university students on microbiology and sustainability themes.',
    icon: '📝',
    type: 'competition',
  },
  {
